#include "dsdgen_combined.hpp"

// skip_days.cpp

namespace __skip_days__ {

using namespace __skip_days__;
using namespace __date__;
using namespace __constants__;
using namespace __scaling__;
using namespace __parallel__;
...
using namespace __genrand__;
using namespace __columns__;
using namespace __StringBuffer__;
using namespace __error_msg__;
using namespace __scaling__;
using namespace __init__;
...
#include <stdio.h>
#include <time.h>
using namespace __dbgen_version__;
using namespace __columns__;
using namespace __build_support__;
using namespace __tables__;
using namespace __misc__;
...
#include <stdio.h>
using namespace __error_msg__;
using namespace __grammar_support__;
static int *LN;
static char *FN;
...
using namespace __tables__;
using namespace __build_support__;
using namespace __tpcds_idx__;
using namespace __scaling__;
using namespace __w_web_sales__;
using namespace __error_msg__;
using namespace __tdefs__;
using namespace __scd__;
using namespace __r_params__;
using namespace __sparse__;
...
int checkSeeds(tdef *pTdef) {
	...
	for (i = pTdef->nFirstColumn; i <= pTdef->nLastColumn; i++) {
		while (__streams__::Streams[i].nUsed < __streams__::Streams[i].nUsedPerRow)
			genrand_integer(&res, DIST_UNIFORM, 1, 100, 0, i);
		if (bSetSeeds) {
			if (__streams__::Streams[i].nUsed > __streams__::Streams[i].nUsedPerRow) {
				fprintf(stderr, "Seed overrun on column %d. Used: %d\n", i, __streams__::Streams[i].nUsed);
                                __streams__::Streams[i].nUsedPerRow = __streams__::Streams[i].nUsed;
				nReturnCode = 1;
			}
		}
                __streams__::Streams[i].nUsed = 0; /* reset for the next time */
	}
...
int row_skip(int tbl, ds_key_t count) {
	...
	for (i = 0; __streams__::Streams[i].nColumn != -1; i++) {
		if (__streams__::Streams[i].nTable == tbl) {
			skip_random(i, count * __streams__::Streams[i].nUsedPerRow);
                        __streams__::Streams[i].nUsed = 0;
                        __streams__::Streams[i].nTotal = count * __streams__::Streams[i].nUsedPerRow;
		}
		if (__streams__::Streams[i].nDuplicateOf && (__streams__::Streams[i].nDuplicateOf != i)) {
			skip_random(__streams__::Streams[i].nDuplicateOf, count * __streams__::Streams[__streams__::Streams[i].nDuplicateOf].nUsedPerRow);
                        __streams__::Streams[__streams__::Streams[i].nDuplicateOf].nUsed = 0;
                        __streams__::Streams[__streams__::Streams[i].nDuplicateOf].nTotal = count * __streams__::Streams[i].nUsedPerRow;
		}
	}
...
using namespace __w_inventory__;
using namespace __scaling__;
using namespace __tpcds_idx__;
using namespace __parallel__;
using namespace __scd__;
 ...
 * Gradient Systems
 */
using namespace __w_call_center__;
using namespace __w_catalog_page__;
using namespace __w_catalog_returns__;
using namespace __w_catalog_sales__;
using namespace __w_customer__;
using namespace __w_customer_address__;
using namespace __w_customer_demographics__;
using namespace __w_datetbl__;
using namespace __w_household_demographics__;
using namespace __w_income_band__;
using namespace __w_inventory__;
using namespace __w_item__;
using namespace __w_promotion__;
using namespace __w_reason__;
using namespace __w_ship_mode__;
using namespace __w_store__;
using namespace __w_store_returns__;
using namespace __w_store_sales__;
using namespace __w_timetbl__;
using namespace __w_warehouse__;
using namespace __w_web_page__;
using namespace __w_web_returns__;
using namespace __w_web_sales__;
using namespace __w_web_site__;
using namespace __dbgen_version__;
using namespace __tdef_functions__;
...
using namespace __tdefs__;
using namespace __scaling__;
using namespace __w_tdefs__;
using namespace __s_tdefs__;
using namespace __tdef_functions__;
using namespace __r_params__;
...
using namespace __init__;
using namespace __append_info__;
using namespace __build_support__;
using namespace __columns__;
using namespace __config__;
using namespace __date__;
...
int mk_w_catalog_returns(void *row, ds_key_t index) {
	...
	if (bStandAlone) {
		...
		if (nTemp >= CR_RETURN_PCT) {
			__parallel__::row_skip(CATALOG_SALES, 1);
			return (1);
		}
...
int vld_w_catalog_sales(int nTable, ds_key_t kRow, int *Permutation) {
	int nLineitem, nMaxLineitem, i;
        ...
        __parallel__::row_skip(nTable, kRow - 1);
        __parallel__::row_skip(CATALOG_RETURNS, (kRow - 1));
	jDate = skipDays(CATALOG_SALES, &kNewDateIndex);
	mk_master(NULL, kRow);
...
int vld_w_store_sales(int nTable, ds_key_t kRow, int *Permutation) {
	int nLineitem, nMaxLineitem, i;
        ...
        __parallel__::row_skip(nTable, kRow - 1);
        __parallel__::row_skip(STORE_RETURNS, kRow - 1);
	jDate = skipDays(STORE_SALES, &kNewDateIndex);
	mk_master(NULL, kRow);
...
int vld_web_sales(int nTable, ds_key_t kRow, int *Permutation) {
	int nLineitem, nMaxLineitem, i;
        ...
        __parallel__::row_skip(nTable, kRow - 1);
        __parallel__::row_skip(WEB_RETURNS, (kRow - 1));
	jDate = skipDays(WEB_SALES, &kNewDateIndex);
	mk_master(NULL, kRow);
